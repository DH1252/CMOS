<script>
  ...
  const pageTitle = 'Website Resmi HIMATEKKOM ITS 2026 | Kabinet Sentra Sinergi';
  const pageDescription = 'Platform resmi HIMATEKKOM ITS untuk informasi publik dan kerja operasional kabinet.';
        ...
        <div class="grid gap-3 md:grid-cols-3">
          <figure class="landing-frame m-0">
            <div class="landing-frame__media">
              <img src="https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=800&q=80" alt="Laptop mahasiswa Teknik Komputer di laboratorium" class="h-48 w-full object-cover" loading="lazy" decoding="async" />
            </div>
          ...
          <figure class="landing-frame m-0">
            <div class="landing-frame__media">
              <img src="https://images.unsplash.com/photo-1772289495966-ddbd08521476?auto=format&fit=crop&w=800&q=80" alt="Mahasiswa berkolaborasi di ruang kerja" class="h-48 w-full object-cover" loading="lazy" decoding="async" />
            </div>
            <figcaption class="landing-frame__caption">
          ...
          <figure class="landing-frame m-0">
            <div class="landing-frame__media">
              <img src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=800&q=80" alt="Ruang kerja dan laboratorium komputer" class="h-48 w-full object-cover" loading="lazy" decoding="async" />
            </div>
            <figcaption class="landing-frame__caption">
        ...
        <div class="landing-panel px-8 py-10 text-center lg:px-14 lg:py-14">
          <div class="mx-auto max-w-[48ch] space-y-5">
            ...
            <p class="text-sm text-[var(--landing-terminal-muted-resolved)]">
              Ikuti <a href="https://www.instagram.com/sentrasinergi/" target="_blank" rel="noreferrer" class="text-[var(--landing-terminal-interactive-resolved)] transition-colors hover:text-[var(--landing-terminal-text-resolved)]">@sentrasinergi</a> di Instagram
            </p>
          </div>
        </div>
      </div>
