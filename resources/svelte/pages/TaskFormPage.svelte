        ...
        >
          ...
          <div class="task-form-field task-form-field-half">
            ...
            >
              ...
              {#each users as user, index (user.value || index)}
                <option
                  value={user.value}
                  selected={String(values.assigned_to || "") ===
          ...
          <div class="task-form-field task-form-field-half">
            ...
            >
              <option
                value="low"
                selected={String(values.priority || "") === "low"}
                >Rendah</option
              >
              <option
                value="medium"
                selected={String(values.priority || "medium") === "medium"}
                >Sedang</option
              >
              <option
                value="high"
                selected={String(values.priority || "") === "high"}
                >Tinggi</option
              >
            </select>
            {#if errors.priority}
