    ...
    <div class="timeline-form-shell">
      <section class="timeline-form-side animate-fadeIn">
        ...
        <div class="timeline-form-preview">
          <div class="timeline-preview-swatch" style={`background:${selectedColor};`}></div>
          <div>
            <small>Tipe</small>
      ...
      <Card.Root class="animate-fadeIn rounded-[10px] border border-border bg-card shadow-none">
        ...
        <Card.Content class="pt-5">
          <form id={formId} method="POST" action={form.action} class="timeline-form-grid">
            ...
            <div class="timeline-form-field">
              ...
              <Input id="timeline-title" name="title" type="text" class="timeline-form-input" aria-invalid={Boolean(errors.title)} value={values.title || ''} required />
              {#if errors.title}
                <div class="timeline-form-error" role="alert">{errors.title}</div>
              {/if}
            </div>

            <div class="timeline-form-field">
              <Label for="timeline-description">Deskripsi</Label>
              <Textarea id="timeline-description" name="description" rows="4" class="timeline-form-textarea" aria-invalid={Boolean(errors.description)} value={values.description || ''} />
              {#if errors.description}
                <div class="timeline-form-error" role="alert">{errors.description}</div>
              {/if}
            </div>
            ...
            <div class="timeline-form-field timeline-form-field-half">
              ...
              <select id="timeline-type" name="type" class="timeline-form-select" bind:value={selectedType} aria-invalid={Boolean(errors.type)} required>
                <option value="global">Global</option>
                <option value="department">Departemen</option>
                <option value="program">Program</option>
              </select>
              {#if errors.type}
                <div class="timeline-form-error" role="alert">{errors.type}</div>
              {/if}
            </div>
            ...
            {#if selectedType === 'department'}
              <div class="timeline-form-field">
                ...
                <select id="timeline-department" name="department_id" class="timeline-form-select" aria-invalid={Boolean(errors.department_id)}>
                ...
                {#if errors.department_id}
                  <div class="timeline-form-error" role="alert">{errors.department_id}</div>
                {/if}
              </div>
            {/if}
            ...
            {#if selectedType === 'program'}
              <div class="timeline-form-field">
                ...
                <select id="timeline-program" name="program_id" class="timeline-form-select" aria-invalid={Boolean(errors.program_id)}>
                ...
                {#if errors.program_id}
                  <div class="timeline-form-error" role="alert">{errors.program_id}</div>
                {/if}
              </div>
            {/if}
            ...
            <div class="timeline-form-field timeline-form-field-half">
              ...
              <Input id="timeline-start" name="start_date" type="date" class="timeline-form-input" aria-invalid={Boolean(errors.start_date)} bind:value={startDate} required />
              {#if errors.start_date}
                <div class="timeline-form-error" role="alert">{errors.start_date}</div>
              {/if}
            </div>
            ...
            <div class="timeline-form-field timeline-form-field-half">
              ...
              <Input id="timeline-end" name="end_date" type="date" class="timeline-form-input" aria-invalid={Boolean(errors.end_date)} bind:value={endDate} required />
              {#if errors.end_date}
                <div class="timeline-form-error" role="alert">{errors.end_date}</div>
              {/if}
            </div>
          </form>

          <FormActions formId={formId} submitLabel={submitLabel} submitIcon="fas fa-save" {cancelAction} />
        </Card.Content>
      </Card.Root>
    </div>
  </div>
