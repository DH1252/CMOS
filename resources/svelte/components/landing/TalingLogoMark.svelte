...
>
  ...
  >
    <path
      ...
      d="M18.36 14.677c-5.137 2.564-8.573 5.564-9.706 7.762-.986 1.91-.899 3.566-.899 3.566.018.297.096 1.23.559 2.224.968 2.023 2.93 2.913 3.976 3.393 5.032 2.284 13.317.052 14.12-.175 0 1.343 0 2.695-.01 4.046 0 .053.01.35.262.594.244.226.55.218.602.209.828-.096 1.674-.21 2.537-.331a64 64 0 0 0 5.826-1.178q.013.892.157 1.954c.113.854.288 1.622.47 2.293-3.296.62-13.83 2.337-22.63-.663-5.616-1.936-7.587-4.752-8.092-5.546-.506-.785-1.404-2.198-1.518-4.186-.235-3.767 2.52-6.619 3.863-8.014 1.605-1.657 3.175-2.555 4.753-3.462a29 29 0 0 1 5.73-2.486"
    />
    <path
      id="Vector_2"
      {stroke}
    ...
    <path
      ...
      stroke-width={strokeWidth}
      fill-opacity={fillOpacity}
      d="m74.975 6.602-2.163 3.924a22.9 22.9 0 0 1 6.846-.026.3.3 0 0 1 .183.122c.105.13.044.296.035.314-.393.776-.794 1.552-1.186 2.328 3.488-.13 6.61 1.36 7.997 3.96.741 1.386.82 2.781.767 3.688h6.436c.035-1.3-.078-3.75-1.378-6.4-.279-.576-2.128-4.248-6.331-6.35-2.625-1.325-5.084-1.473-7.168-1.622a25.5 25.5 0 0 0-4.038.062"
    />
    <path
      id="Vector_5"
      {stroke}
    ...
    <path
      ...
      stroke-width={strokeWidth}
      fill-opacity={fillOpacity}
      d="M32.104 41.075a64 64 0 0 0 2.145-.218c6.907-.864 12.915-3.035 17.965-5.634 1.168.733 2.346 1.474 3.514 2.206-5.006 2.94-10.003 5.878-15.008 8.817-2.87-1.727-5.747-3.445-8.616-5.171"
    />
    <path
      id="Vector_7"
      {stroke}
      stroke-width={strokeWidth}
      fill-opacity={fillOpacity}
      d="M21.01 31.002V11.354L40.85 0l16.57 9.55-6.872 3.819-9.706-5.765-13.509 7.901.027 13.657z"
    />
    <path
      id="Vector_8"
      {stroke}
      stroke-width={strokeWidth}
      fill-opacity={fillOpacity}
      d="M29.897 28.473V16.63l10.91-6.41c2.424 1.43 4.84 2.861 7.264 4.291a59 59 0 0 0-3.732 2.242 56 56 0 0 0-4.988 3.68c1.125.81 2.25 1.622 3.366 2.433a78 78 0 0 1-7.526 3.619 77 77 0 0 1-5.294 1.988"
    />
  </g>
  <defs>
    <filter
