...
<svg
  ...
  viewBox="0 0 97.895 54.246"
  class={className}
>
  <g
    id="Logo Mark"
    fill="var(--fill-0, white)"
    filter="url(#filter0_d_554_3314)"
  >
    <path
      id="Vector_1"
      {stroke}
  ...
  <defs>
    ...
    >
      ...
      <feBlend in2="BackgroundImageFix" result="effect1_dropShadow_554_3314" />
      <feBlend
        in="SourceGraphic"
        in2="effect1_dropShadow_554_3314"
        result="shape"
      />
    </filter>
  </defs>
