    ...
    >
        ...
        <div class="flex items-center gap-3">
          ...
          {#if graphic.image}
            <button
              ...
              onclick={() =>
                document.getElementById(`upload-graphic-${gIndex}`).click()}
            >
      ...
      <div class="space-y-6">
        {#if graphic.image}
          ...
          <!-- Bottom Grid: Panorama Settings & Data Overlays -->
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- Panorama Settings -->
            <div class="md:col-span-1">
              <div
                class="rounded-lg border border-border/50 bg-muted/30 p-3 h-fit"
              >
                <h4
                        ...
                        <div class="mt-2 flex items-center gap-3">
                          {#if overlay.picture}
                            ...
                            <button
                              ...
                              onclick={() => {
                                graphics[gIndex].overlays[oIndex].picture =
                                  null;
                                graphics = [...graphics];
                              }}
                            >
